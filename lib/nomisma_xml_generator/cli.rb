...
module NomismaXmlGenerator
  ...
  class Cli < Thor
    ...
    def scrape_catalog_detail
      output_dir = options[:output_dir]
      detail_scraper = NomismaXmlGenerator::CatalogDetailScraper.new(options[:coin_list_path], output_dir: output_dir)
    ...
    def generate_xml
      collection = NomismaXmlGenerator::CoinCollection.new(json_dir: options[:json_dir])
